            ...
            <header :class="GetIsMenuOpen ? '' : ''"
                ...
                <div class="flex justify-between w-full mx-3">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="text-xs uppercase text-gray-600">Olá, Heuder Rodrigues de Sena</div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-8 h-8 cursor-pointer text-purple-500 hover:text-red-400">
                            <path stroke-linecap="round" stroke-linejoin="round"
