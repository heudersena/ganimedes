<template>
    <div>
        ...
        <div class="mt-16">
            <p v-show="image_payments" class="ml-4 text-sx font-bold mb-2 text-gray-600">Abra o aplicativo do seu banco e
                faça o
                pagamento</p>
            <div class="flex flex-col h-[180px] mt-4 ml-4">
                <div class="">
                    <img v-show="image_payments" :src="'data:image/jpeg;charset=utf-8;base64, ' + image_payments"
                        class="h-[180px]">
                </div>
