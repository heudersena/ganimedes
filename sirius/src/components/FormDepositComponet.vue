    ...
    <div>
        ...
        <label class="text-xs mb-2 font-bold text-gray-500">Digite um valor</label>
          <Field
            ...
            class="w-full border-none placeholder-gray-300 text-xs"
            placeholder="Quantos quer depositar?"
          />
          ...
          <button :disabled="paymentsIsLoading">
            ...
            <span v-show="!paymentsIsLoading" class="bg-[#7159c1] hover:bg-[#7159c1]/90 w-full flex justify-center p-3 rounded-sm text-white uppercase text-xs">Fazer deposito</span>
          </button>
        ...
        <div class="mt-16">
        <p v-show="image_payments" class="ml-4 text-sx font-bold mb-2 text-gray-600">Abra o aplicativo do seu banco e faça o pagamento</p>
